...
\begin{figure}[!htb]
    ...
    \includesvg[pretex=\footnotesize]{figures/3review/nn/nn3.svg}
...
\begin{figure}[!htb]
    ...
    \includesvg[pretex=\footnotesize]{figures/3review/nn/mae_chart.svg}
...
\begin{figure}[!htb]
    ...
    \includesvg[pretex=\footnotesize]{figures/3review/nn/gradient_descent.svg}
...
\emph{Adam} is an algorithm developed by \citet{kingma2017} for first-order gradient-based optimization of stochastic objective functions, like the loss function, as seen in the~\cref{sec:loss_function}.
