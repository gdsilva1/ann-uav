...
states, _ = preprocessing_from_matlab(states_raw, n=500)
forces, _ = preprocessing_from_matlab(forces_raw, n=500)
...
train_data, test_data = torch.utils.data.random_split(dataset, [TRAIN_PROP, 1-TRAIN_PROP])
