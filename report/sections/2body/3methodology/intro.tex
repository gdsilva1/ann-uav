...
While the engineering goal of \gls*{ai} is to solve real-world problems using it as an equipment, the scientific goal is to determine which ideas explain the various sorts of intelligence \citep{winston1992} and the current objective is to use \gls*{ai} from the engineering perspective.