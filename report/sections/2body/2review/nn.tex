...
From a determined data, there are several classifications that can be extracted from them. Their pattern will determine what kind of classification, whether it is a classification or a regression data, for instance.
For classification, the cross-entropy function is a common loss function adopted.
