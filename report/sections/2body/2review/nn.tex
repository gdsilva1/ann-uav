...
\end{equation}
%
where \(Q\) is a distribution relative to another distribution \(P\) over a given set, being both discrete probability distribution, and \(n\) is the size of the sample.
